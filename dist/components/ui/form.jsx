...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formDescriptionId} className={(0, utils_1.cn)("text-sm text-stone-500 dark:text-stone-400", className)} {...props}/>);
});
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (<p ref={ref} id={formMessageId} className={(0, utils_1.cn)("text-sm font-medium text-red-500 dark:text-red-900", className)} {...props}>
      {body}
    </p>);
});
